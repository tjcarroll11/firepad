...
firepad.Socketpad = (function(global) {
  ...
  function Socketpad(socket, place, filename, options) {
    var CodeMirror = global.CodeMirror;
    if (!(this instanceof Socketpad)) { return new Socketpad(socket, place, filename, options); }
    ...
    this.socketAdapter_ = new SocketAdapter(socket, userId, userColor, filename);
    if (this.codeMirror_) {
